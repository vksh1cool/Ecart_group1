...
<div class="form-container">
    ...
    <!-- Display Product ID as uneditable text -->
    <p><strong>Product ID:</strong> <%= productId %></p>
    
    <!-- Update form for the product -->
    <form id="UpdateProduct" method="post" action="UpdateProduct">
        <input type="hidden" name="productId" value="<%= productId %>">
        
        <div class="form-group">
            <label for="productName">Product Name (Cannot be edited):</label>
            <input type="text" id="productName" name="productName" value="<%= productName%>" readonly>
        </div>
        <div class="form-group">
            <label for="productPrice">Product Price:</label>
            <input type="number" id="productPrice" name="productPrice"  step="0.01" required autocomplete="off">
        </div>
        <div class="form-group">
            <label for="productCategory">Product Category:</label>
            <input type="text" id="productCategory" name="productCategory" required autocomplete="off">
        </div>
        <div class="form-group">
            <label for="productDescription">Product Description:</label>
            <input type="text" id="productDescription" name="productDescription" maxlength="200" required autocomplete="off">
        </div>
